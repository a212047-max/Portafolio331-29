...
namespace CS4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // c. Múltiple: Instrucciones if-else if-else
            // Bloque de instrucciones
           ...
           int salón = 332; // A la variable "salón, se le asigna, inicialmente, 331.
           if (salón == 331) // Si el valor de la variable "salón" es 331, entonces...
           {
               Console.WriteLine("Exactas"); // ...impresión de especialidad: "Exactas".
           }
           else if (salón == 332 || salón == 333) // Si no es igual a 331, pero sí a 332 o a 333, entonces...
           {
